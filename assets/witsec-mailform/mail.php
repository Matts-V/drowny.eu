...
$to = "drowny.company@gmail.com";														// To Address
$toAlt = "";												// Additional Recipients
$from = "no-reply@drowny.eu";													// From Address
$fromName = "Drowny";											// From Name
...
$template = "*Beta-Tester application*<br><br>{name} want's to become a Beta-Tester.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "Beta-Tester (Drowny)";						// Autorespond Custom Subject
$autorespondTemplate = "Hi {name}<br><br>Thank you for showing your intrest in becoming a Beta-Tester. We will be in touch in about 1 - 7 days.<br><br>---<br>Have a nice day.";					// Autorespond Template
$rcp = ("0" == "1" ? true : false);						// Use reCAPTCHA
$rcpVersion = "2";								// reCAPTCHA Version
$rcpScore = "0.5";									// reCAPTCHA Score
$rcpSecret = "6LeF_ushAAAAAGeuoko6yr5ldtzELuBApDaf3Phc";								// reCAPTCHA Secret Key
$smtp = ("1" == "1" ? true : false);							// Use SMTP
$smtpDebug = ("0" == "1" ? 3 : 0);						// SMTP Debug
$smtpHost = "smtp.sendgrid.net";											// SMTP Host
$smtpPort = "465";											// SMTP Port
$smtpSecure = "ssl";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "apikey";									// SMTP Username
$smtpPassword = "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";									// SMTP Password
